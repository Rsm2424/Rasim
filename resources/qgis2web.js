...
map.getView().fit([8694091.021187, 641872.706032, 9370769.806611, 1104078.856648], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">web map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (19 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'gjhtyjhdtryhtgbdrhc';
            }
